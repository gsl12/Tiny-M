...
Bowden and direct drive extruder using [CroXY's Sailfin](https://github.com/CroXY3D/Sailfin-Extruder), [Annex Engineering's Sherpa Mini](https://github.com/Annex-Engineering/Sherpa_Mini-Extruder) or [Bondtech's LGX Lite Extruder](https://www.bondtech.se/product/lgx-lite-extruder-custom/) are now available.  An integrated toolhead similar to Voron's Afterburner is in development.
